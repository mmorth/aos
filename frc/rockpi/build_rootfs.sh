...
copyfile root.root 644 etc/apt/sources.list.d/aos.list
...
target "cd /tmp && wget https://realtimeroboticsgroup.org/build-dependencies/libmali-midgard-t86x-r14p0-x11_1.9-1_arm64.deb && sudo dpkg -i libmali-midgard-t86x-r14p0-x11_1.9-1_arm64.deb && rm libmali-midgard-t86x-r14p0-x11_1.9-1_arm64.deb"
...
copyfile root.root 644 etc/systemd/system/aos.service
copyfile root.root 644 etc/systemd/system/aoschrt.service
...
target "systemctl enable aos"
target "systemctl enable aoschrt"
target "/root/bin/change_hostname.sh pi-4646-1"
