#ifndef FRC_ORIN_GPU_APRILTAG_H_
#define FRC_ORIN_GPU_APRILTAG_H_
...
class ApriltagDetector {
 public:
  ...
  flatbuffers::Offset<frc::vision::TargetPoseFbs> BuildTargetPose(
 ...
 private:
  ...
  const frc::vision::calibration::CameraCalibration *calibration_;
  cv::Mat intrinsics_;
...
#endif  // FRC_ORIN_GPU_APRILTAG_H_
