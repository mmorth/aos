#ifndef FRC_AUTONOMOUS_BASE_AUTONOMOUS_ACTOR_H_
#define FRC_AUTONOMOUS_BASE_AUTONOMOUS_ACTOR_H_
...
class BaseAutonomousActor : public ::aos::common::actions::ActorBase<Goal> {
 ...
 protected:
  ...
  SplineHandle PlanSpline(
      std::function<flatbuffers::Offset<frc::MultiSpline>(
          aos::Sender<frc::control_loops::drivetrain::SplineGoal>::Builder
  ...
  ::aos::Fetcher<::frc::control_loops::drivetrain::Goal>
...
#endif  // FRC_AUTONOMOUS_BASE_AUTONOMOUS_ACTOR_H_
