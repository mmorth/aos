#ifndef FRC_CONTROL_LOOPS_DOUBLE_JOINTED_ARM_DYNAMICS_H_
#define FRC_CONTROL_LOOPS_DOUBLE_JOINTED_ARM_DYNAMICS_H_
...
class Dynamics {
 public:
  ...
  const ::Eigen::Matrix<double, 4, 1> UnboundedDiscreteDynamics(
    ...
    return ::frc::control_loops::RungeKuttaU(
...
#endif  // FRC_CONTROL_LOOPS_DOUBLE_JOINTED_ARM_DYNAMICS_H_
