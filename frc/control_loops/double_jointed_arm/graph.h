#ifndef FRC_CONTROL_LOOPS_DOUBLE_JOINTED_ARM_GRAPH_H_
#define FRC_CONTROL_LOOPS_DOUBLE_JOINTED_ARM_GRAPH_H_
...
#endif  // FRC_CONTROL_LOOPS_DOUBLE_JOINTED_ARM_GRAPH_H_
