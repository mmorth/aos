#ifndef FRC_CONTROL_LOOPS_DOUBLE_JOINTED_ARM_TRAJECTORY_H_
#define FRC_CONTROL_LOOPS_DOUBLE_JOINTED_ARM_TRAJECTORY_H_
...
#endif  // FRC_CONTROL_LOOPS_DOUBLE_JOINTED_ARM_TRAJECTORY_H_
