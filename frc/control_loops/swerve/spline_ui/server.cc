...
namespace frc::control_loops::swerve::spline_ui {
...
int main(int argc, char **argv) {
  ...
  auto websocket_handler = std::make_shared<
      frc::control_loops::swerve::spline_ui::WebsocketHandler>();
  server.addWebSocketHandler("/ws", websocket_handler);

  server.serve("frc/control_loops/swerve/spline_ui/www/static_files",
