#ifndef FRC_CONTROL_LOOPS_SWERVE_LINEARIZED_CONTROLLER_H_
#define FRC_CONTROL_LOOPS_SWERVE_LINEARIZED_CONTROLLER_H_
#include <memory>
...
#include "frc/control_loops/swerve/dynamics.h"
 ...
 public:
  ...
  GainMatrix SolveDare(const StateSquare &A, const BMatrix &B,
    ...
    if (solver == DareSolver::Slicot) {
      ...
      *sb02od_exit_code = (frc::controls::dlqr<NStates, kNumInputs>(
...
#endif  // FRC_CONTROL_LOOPS_SWERVE_LINEARIZED_CONTROLLER_H_
