...
import numpy
from frc.control_loops.python import polytope
import frc.control_loops.python.drivetrain
from frc.control_loops.python import control_loop
from frc.control_loops.python import controls
from frc.control_loops.python.cim import CIM
...
class VelocityDrivetrainModel(control_loop.ControlLoop):
    ...
    def __init__(self,
        ...
        self._drivetrain = frc.control_loops.python.drivetrain.Drivetrain(
            left_low=left_low,
            right_low=right_low,
