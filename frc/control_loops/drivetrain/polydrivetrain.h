#ifndef FRC_CONTROL_LOOPS_DRIVETRAIN_POLYDRIVETRAIN_H_
...
#else
#include "frc/control_loops/drivetrain/drivetrain_goal_float_generated.h"
...
class PolyDrivetrain {
 public:
  ...
  void SetPosition(const ::frc::control_loops::drivetrain::Position *position,
 ...
 private:
  ...
  const ::frc::controls::HVPolytope<2, 4, 4, Scalar> U_Poly_;
  ...
  ::frc::control_loops::drivetrain::PositionT last_position_;
  ::frc::control_loops::drivetrain::PositionT position_;
  int counter_;
...
void PolyDrivetrain<Scalar>::SetPosition(
    const ::frc::control_loops::drivetrain::Position *position, Gear left_gear,
    Gear right_gear) {
...
#endif  // FRC_CONTROL_LOOPS_DRIVETRAIN_POLYDRIVETRAIN_H_
