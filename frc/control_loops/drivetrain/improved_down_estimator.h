#ifndef FRC_CONTROL_LOOPS_DRIVETRAIN_IMPROVED_DOWN_ESTIMATOR_H_
#define FRC_CONTROL_LOOPS_DRIVETRAIN_IMPROVED_DOWN_ESTIMATOR_H_
...
class DrivetrainUkf : public QuaternionUkf {
 public:
  ...
  static Eigen::Vector4d QuaternionDerivative(Eigen::Vector3d omega,
    ...
    return frc::controls::QuaternionDerivative(omega, q_matrix);
  }
...
#endif  // FRC_CONTROL_LOOPS_DRIVETRAIN_IMPROVED_DOWN_ESTIMATOR_H_
