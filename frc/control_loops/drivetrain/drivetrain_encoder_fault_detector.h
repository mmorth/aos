#ifndef FRC_CONTROL_LOOPS_DRIVETRAIN_DRIVETRAIN_ENCODER_FAULT_DETECTOR_H_
#define FRC_CONTROL_LOOPS_DRIVETRAIN_DRIVETRAIN_ENCODER_FAULT_DETECTOR_H_
...
#include "frc/control_loops/encoder_fault_detector.h"
...
class DrivetrainEncoderFaultDetector {
 ...
 private:
  ...
  aos::Sender<frc::control_loops::drivetrain::Status> drivetrain_status_sender_;
