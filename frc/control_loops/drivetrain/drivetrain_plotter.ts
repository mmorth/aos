...
export function plotDrivetrain(conn: Connection, element: Element): void {
  ...
  const goal = aosPlotter.addMessageSource('/drivetrain', 'frc.control_loops.drivetrain.Goal');
  ...
  const localizerOuput = aosPlotter.addMessageSource(
      '/localizer', 'frc.controls.LocalizerOutput');
