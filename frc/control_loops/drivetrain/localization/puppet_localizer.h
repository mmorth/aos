#ifndef FRC_CONTROL_LOOPS_DRIVETRAIN_LOCALIZATION_PUPPET_LOCALIZER_H_
#define FRC_CONTROL_LOOPS_DRIVETRAIN_LOCALIZATION_PUPPET_LOCALIZER_H_
...
class PuppetLocalizer
    : public frc::control_loops::drivetrain::LocalizerInterface {
 public:
  typedef frc::control_loops::TypedPose<float> Pose;
  typedef frc::control_loops::drivetrain::HybridEkf<float> HybridEkf;
  ...
  PuppetLocalizer(
      ...
      std::unique_ptr<frc::control_loops::drivetrain::TargetSelectorInterface>
          target_selector = {});
  frc::control_loops::drivetrain::HybridEkf<double>::State Xhat()
      const override {
    return ekf_.X_hat().cast<double>();
  }
  frc::control_loops::drivetrain::TargetSelectorInterface *target_selector()
      override {
  ...
  void Reset(aos::monotonic_clock::time_point t,
             const frc::control_loops::drivetrain::HybridEkf<double>::State
                 &state) override;
...
#endif  // FRC_CONTROL_LOOPS_DRIVETRAIN_LOCALIZATION_PUPPET_LOCALIZER_H_
