#ifndef FRC_CONTROL_LOOPS_DRIVETRAIN_H_
#define FRC_CONTROL_LOOPS_DRIVETRAIN_H_
...
#include "frc/control_loops/drivetrain/ssdrivetrain.h"
...
class DrivetrainFilters {
 ...
 private:
  ...
  aos::Fetcher<frc::IMUValuesBatch> imu_values_fetcher_;
  aos::Fetcher<frc::sensors::GyroReading> gyro_reading_fetcher_;
...
class DrivetrainLoop
 ...
 public:
  ...
  // drivetrain at frc::control_loops::drivetrain
 ...
 protected:
  ...
  void RunIteration(
      ...
      const ::frc::control_loops::drivetrain::Position *position,
      aos::Sender<::frc::control_loops::drivetrain::Output>::Builder *output,
      aos::Sender<::frc::control_loops::drivetrain::Status>::Builder *status)
      override;
  ...
  aos::Sender<::frc::control_loops::drivetrain::RioLocalizerInputsStatic>
      localizer_input_sender_;
};

}  // namespace frc::control_loops::drivetrain

#endif  // FRC_CONTROL_LOOPS_DRIVETRAIN_H_
