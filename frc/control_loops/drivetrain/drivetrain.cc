...
DrivetrainFilters::DrivetrainFilters(const DrivetrainConfig<double> &dt_config,
    ...
    : dt_config_(dt_config),
      ...
      imu_values_fetcher_(
          event_loop->TryMakeFetcher<::frc::IMUValuesBatch>("/drivetrain")),
      gyro_reading_fetcher_(
          event_loop->MakeFetcher<::frc::sensors::GyroReading>("/drivetrain")),
    ...
    : frc::controls::ControlLoop<Goal, Position, Status, Output>(event_loop,
      ...
      localizer_input_sender_(
          event_loop->TryMakeSender<
              frc::control_loops::drivetrain::RioLocalizerInputsStatic>(
              "/drivetrain")) {
