#ifndef FRC_CONTROL_LOOPS_DRIVETRAIN_SSDRIVETRAIN_H_
#define FRC_CONTROL_LOOPS_DRIVETRAIN_SSDRIVETRAIN_H_
...
class DrivetrainMotorsSS {
 public:
  ...
  void SetOutput(::frc::control_loops::drivetrain::OutputT *output) const;
  void PopulateStatus(
 ...
 private:
  ...
  // (-12, -12) to (12, 12).
  const ::frc::controls::HVPolytope<2, 4, 4> U_poly_;
...
#endif  // FRC_CONTROL_LOOPS_DRIVETRAIN_SSDRIVETRAIN_H_
