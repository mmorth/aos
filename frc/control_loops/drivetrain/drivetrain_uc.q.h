#ifndef FRC_CONTROL_LOOPS_DRIVETRAIN_DRIVETRAIN_Q_H_
#define FRC_CONTROL_LOOPS_DRIVETRAIN_DRIVETRAIN_Q_H_
#include <array>
...
struct DrivetrainQueue_Status {
  ...
  float ground_angle;
  ::frc::control_loops::GearLogging gear_logging;
  ::frc::control_loops::CIMLogging cim_logging;
};
...
#endif  // FRC_CONTROL_LOOPS_DRIVETRAIN_DRIVETRAIN_Q_H_
