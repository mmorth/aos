#ifndef FRC_CONTROL_LOOPS_DRIVETRAIN_LINE_FOLLOW_DRIVETRAIN_H_
#define FRC_CONTROL_LOOPS_DRIVETRAIN_LINE_FOLLOW_DRIVETRAIN_H_
#include "Eigen/Dense"
...
class LineFollowDrivetrain {
 public:
  ...
  // over.
  bool SetOutput(::frc::control_loops::drivetrain::OutputT *output);
...
#endif  // FRC_CONTROL_LOOPS_DRIVETRAIN_LINE_FOLLOW_DRIVETRAIN_H_
