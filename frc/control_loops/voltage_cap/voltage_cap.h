#ifndef FRC_CONTROL_LOOPS_VOLTAGE_CAP_VOLTAGE_CAP_H_
#define FRC_CONTROL_LOOPS_VOLTAGE_CAP_VOLTAGE_CAP_H_
...
#endif  // FRC_CONTROL_LOOPS_VOLTAGE_CAP_VOLTAGE_CAP_H_
