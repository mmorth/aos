#ifndef FRC_CONTROL_LOOPS_ENCODER_FAULT_DETECTOR_H_
#define FRC_CONTROL_LOOPS_ENCODER_FAULT_DETECTOR_H_

#include "aos/containers/sized_array.h"
#include "aos/time/time.h"
#include "frc/control_loops/can_talonfx_generated.h"
#include "frc/control_loops/encoder_fault_status_generated.h"
 ...
 public:
  ...
  void Iterate(double encoder_position,
               const flatbuffers::Vector<
                   flatbuffers::Offset<frc::control_loops::CANTalonFX>>
                   *falcon_positions,
...
void EncoderFaultDetector<NumberofMotors>::Iterate(
    ...
    const flatbuffers::Vector<
        flatbuffers::Offset<frc::control_loops::CANTalonFX>> *falcon_positions,
    aos::monotonic_clock::time_point current_time) {
...
#endif  // FRC_CONTROL_LOOPS_ENCODER_FAULT_DETECTOR_H_