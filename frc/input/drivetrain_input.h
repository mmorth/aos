...
#include "frc/control_loops/swerve/swerve_drivetrain_joystick_goal_static.h"
...
class DrivetrainInputReader {
  ...
  DrivetrainInputReader(::aos::EventLoop *event_loop,
      ...
      : wheel_(wheel),
        ...
        drivetrain_status_fetcher_(
            event_loop->MakeFetcher<::frc::control_loops::drivetrain::Status>(
                "/drivetrain")),
        drivetrain_goal_sender_(
            event_loop->MakeSender<::frc::control_loops::drivetrain::Goal>(
                "/drivetrain")) {}
 ...
 private:
  ...
  virtual WheelAndThrottle GetWheelAndThrottle(
      const ::frc::input::driver_station::Data &data) = 0;
...
class SwerveDrivetrainInputReader {
 ...
 private:
  // Computes the steering and throttle from the provided driverstation data.
  SwerveGoals GetSwerveGoals(const ::frc::input::driver_station::Data &data);
