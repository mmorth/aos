...
using frc::control_loops::drivetrain::PistolBottomButtonUse;
using frc::control_loops::drivetrain::PistolSecondButtonUse;
using frc::control_loops::drivetrain::PistolTopButtonUse;

namespace frc::input {

class SwerveJoystickInput : public ::frc::input::JoystickInput {
 public:
