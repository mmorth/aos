...
#include "frc/autonomous/auto_mode_generated.h"
...
class ActionJoystickInput : public ::frc::input::JoystickInput {
 public:
  ...
  ActionJoystickInput(
      ...
      : ::frc::input::JoystickInput(event_loop),
        input_config_(input_config),
        drivetrain_input_reader_(
            DrivetrainInputReader::Make(event_loop, input_type, dt_config)),
        dt_config_(dt_config),
        autonomous_action_factory_(
            ::frc::autonomous::BaseAutonomousActor::MakeFactory(event_loop)),
        autonomous_mode_fetcher_(
            event_loop->MakeFetcher<::frc::autonomous::AutonomousMode>(
                "/autonomous")) {}
 ...
 protected:
  ...
  const ::frc::control_loops::drivetrain::DrivetrainConfig<double> dt_config()
      const {
    return dt_config_;
  }
  ...
  void set_vision_align_fn(
      ::std::function<bool(const ::frc::input::driver_station::Data &data)>
          vision_align_fn) {
 ...
 private:
  ...
  virtual void HandleTeleop(const ::frc::input::driver_station::Data &data) = 0;

  void RunIteration(const ::frc::input::driver_station::Data &data) override;

  void DoRunIteration(const ::frc::input::driver_station::Data &data);
  ...
  const ::frc::control_loops::drivetrain::DrivetrainConfig<double> dt_config_;

  ::frc::autonomous::BaseAutonomousActor::Factory autonomous_action_factory_;

  ::aos::Fetcher<::frc::autonomous::AutonomousMode> autonomous_mode_fetcher_;
};
