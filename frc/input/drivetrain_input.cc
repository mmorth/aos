...
void DrivetrainInputReader::HandleDrivetrain(
  ...
  frc::ProfileParameters::Builder linear_builder =
      builder.MakeBuilder<frc::ProfileParameters>();

  linear_builder.add_max_velocity(3.0);
  linear_builder.add_max_acceleration(20.0);

  flatbuffers::Offset<frc::ProfileParameters> linear_offset =
...
double UnwrappedAxis(const ::frc::input::driver_station::Data &data,
