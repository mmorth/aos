#ifndef FRC_VISION_TARGET_MAPPER_H_
#define FRC_VISION_TARGET_MAPPER_H_
...
#include "frc/vision/ceres/types.h"
...
void AbslStringify(Sink &sink, ceres::examples::Pose3d pose) {
  auto rpy = frc::vision::PoseUtils::QuaternionToEulerAngles(pose.q);
  absl::Format(&sink,
...
#endif  // FRC_VISION_TARGET_MAPPER_H_
