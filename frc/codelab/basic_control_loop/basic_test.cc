...
#include "frc/codelab/basic_control_loop/basic.h"
...
class BasicControlLoopTest : public ::frc::testing::ControlLoopTest {
 public:
  BasicControlLoopTest()
      : ::frc::testing::ControlLoopTest(
            aos::configuration::ReadConfig("frc/codelab/aos_config.json"),
