#ifndef FRC_WPILIB_TALONFX_MOTOR_H_
#define FRC_WPILIB_TALONFX_MOTOR_H_
...
#include "frc/control_loops/can_talonfx_static.h"

namespace control_loops = ::frc::control_loops;
...
#endif  // FRC_WPILIB_TALONFX_MOTOR_H_
