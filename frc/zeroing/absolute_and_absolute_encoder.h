#ifndef frc_zeroing_absolute_and_absolute_encoder_h_
#define frc_zeroing_absolute_and_absolute_encoder_h_
...
#endif  // FRC_ZEROING_ABSOLUTE_AND_ABSOLUTE_ENCODER_H_
